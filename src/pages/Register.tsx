...
export default function Register() {
  console.log("🔥 FINAL REGISTER URL:");
console.log(
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("❌ REGISTER FAILED FULL ERROR:", err);
            ...
            {["name", "email", "password"].map((f) => (
              <div key={f}>
                ...
                <input
                  ...
                  className="mt-1 w-full bg-muted/30 border border-border rounded-xl px-4 py-3 text-sm"
                />
              </div>
            ))}
