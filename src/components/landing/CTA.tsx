      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="text-xs tracking-[0.3em] text-muted-foreground uppercase mb-5">// Join the network</div>
            <h2 className="font-display text-4xl md:text-6xl font-bold leading-[1.05] tracking-tight max-w-3xl mx-auto text-balance">
              Stop scrolling job boards. <span className="text-liquid">Let the work find you.</span>
            </h2>
            <p className="mt-6 text-muted-foreground text-lg max-w-xl mx-auto">
              Apply once. Get matched continuously. Free for developers, forever.
            </p>
            <div className="mt-10 flex flex-wrap gap-3 justify-center">
              <button className="btn-liquid">Create developer profile</button>
              <button className="btn-ghost-liquid">I'm hiring →</button>
            </div>
          </div>
        </motion.div>
      </div>
